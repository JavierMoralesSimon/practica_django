...
El primer paso para una exitosa ejecución del proyecto es la instalación de Python si no lo tenemos instalado ya. Posteriormente, este repositorio el cual incluye el proyecto, se clonaría y con él nos conectariamos a un entorno virtual previamente creado si es que decidimos usar como área de trabajo esto y no nuestro ordenador local. Por último, en la área elegida ejecutaríamos los siguientes comandos aunque de nuevo, si los que involucran instalar algo, ya tenemos eso instalado, se omitirían:
